...
import { BACKEND_CONFIG } from '../../api/types';
...
export const UploadForm: React.FC<UploadFormProps> = ({ onUploadSuccess }) => {
  ...
  const validateFile = (file: File): string | null => {
    ...
    if (file.size > BACKEND_CONFIG.MAX_UPLOAD_SIZE_BYTES) {
      return `File too large. Maximum size: ${BACKEND_CONFIG.MAX_UPLOAD_SIZE_MB} MB`;
    }
    return null;
  };
  ...
  return (
    <div className="upload-page">
      <div className="upload-card">
        ...
        <p className="hint">Maximum size: {BACKEND_CONFIG.MAX_UPLOAD_SIZE_MB} MB</p>
